	...
	while(continuer){
		...
		if(menu.action==10){
			...
			e=AnimateEnemy(e,stat);
			 AfficherEnemy(e,ecran,evan.pos_hero2);
			...
			if ((enigmeresolu2==0)&&(bckg.pos_background2.x==3200)){
				enigmeresolu2==1;
					while(continuerenig){

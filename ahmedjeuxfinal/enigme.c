...
void writeqs(SDL_Surface *ecran){
	...
	char qus[70]="To open the door u have to put the right answer in the blank";
	SDL_Color color;
		color.r = 255 ;
        color.g = 255 ;
        color.b = 255 ;
...
/**
* @brief To writeqs.
* @param enig the enigme
* @return integer the right answer
*/
...
/**
* @brief To initialiser and  affichier_enigme .
* @param enig the enigme
* @param ecran the screen
* @return nothing
*/
